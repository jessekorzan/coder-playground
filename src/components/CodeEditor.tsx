    ...
    <div className="h-full bg-white">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full flex flex-col">
        <TabsList className="grid w-full grid-cols-3 rounded-none border-b bg-gray-50">
          <TabsTrigger 
            value="html" 
            className="flex items-center space-x-2 data-[state=active]:bg-orange-100 data-[state=active]:text-orange-700"
          >
          ...
          <TabsTrigger 
            value="js" 
            className="flex items-center space-x-2 data-[state=active]:bg-yellow-100 data-[state=active]:text-yellow-700"
          >
          ...
          <TabsContent value="html" className="h-full m-0">
            <div className="h-full flex flex-col">
              ...
              <textarea
                ...
                className="flex-1 w-full p-4 font-mono text-sm border-0 resize-none focus:outline-none focus:ring-2 focus:ring-orange-200"
          ...
          <TabsContent value="css" className="h-full m-0">
            <div className="h-full flex flex-col">
              ...
              <textarea
                ...
                className="flex-1 w-full p-4 font-mono text-sm border-0 resize-none focus:outline-none focus:ring-2 focus:ring-blue-200"
          ...
          <TabsContent value="js" className="h-full m-0">
            <div className="h-full flex flex-col">
              ...
              <textarea
                ...
                className="flex-1 w-full p-4 font-mono text-sm border-0 resize-none focus:outline-none focus:ring-2 focus:ring-yellow-200"
